...
class Artikal(models.Model):
    ...
    kolicina_na_stanju  = models.IntegerField(default=0)
    nema_na_stanju      = models.BooleanField(default=False)
    ...
    #def smanji_kolicinu(self, koliko):
    #    self.kolicina_na_stanju = self.kolicina_na_stanju - koliko
    #    if self.kolicina_na_stanju == 0:
    #        self.delete()
